          ...
          <div className="w-auto">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 pt-2">
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-gray-300 text-sm text-gray-600 hover:bg-gray-100 cursor-pointer transition-colors">
                  <svg
                    className="w-4 h-4"
                    viewBox="0 0 24 24"
                    fill="currentColor"
