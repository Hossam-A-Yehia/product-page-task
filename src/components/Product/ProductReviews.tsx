...
export const ProductReviews = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 bg-white">
      <h1 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Product Reviews</h1>
                ...
                {[5, 4, 3, 2, 1].map((rating) => (
                  <label key={rating} className="flex items-center gap-2 cursor-pointer">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-sm text-[#818B9C] font-semibold">{rating}</span>
                    </div>
                  </label>
                ))}
              </div>
                ...
                {[
                  ...
                  <label key={topic} className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded border-gray-300 text-gray-800 focus:ring-gray-800"
                    />
                    <span className="text-sm text-[#818B9C] font-semibold">{topic}</span>
                  </label>
                ))}
              </div>
            )}
        ...
        <div className="flex-1">
          ...
          <div className="space-y-4">
              ...
              <div key={review.id} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1 sm:gap-2">
                    ...
                    <button className="p-1.5 sm:p-1 hover:bg-gray-50 rounded active:bg-gray-100 transition-colors">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <Button variant="ghost" className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center p-1 sm:p-2 border border-gray-300 rounded-md hover:bg-gray-50">
