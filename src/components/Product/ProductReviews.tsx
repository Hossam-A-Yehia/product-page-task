  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-white">
        ...
        <div className="flex items-start gap-[120px]">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-sm text-gray-500 mt-1">from 1.25k reviews</p>
            </div>
          </div>
      ...
      <div className="flex gap-6">
        <div className="w-80 border-2 border-dashed border-gray-300 rounded-lg p-4 h-min">
          <h3 className="font-bold mb-4 border-b-2 border-dashed border-gray-300 pb-2">
            Reviews Filter
          </h3>
                ...
                {[5, 4, 3, 2, 1].map((rating) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-sm text-[#818B9C] font-semibold">
                        {rating}
                      </span>
                    </div>
                  </label>
        ...
        <div className="flex-1">
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium bg-[#EBEBEB] hover:bg-gray-50">
                All Reviews
              </button>
            ...
            {reviews.map((review) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button className="flex items-center gap-1 px-3 py-1 hover:bg-gray-50 rounded">
                      <svg
                        className="w-5 h-5"
                        fill="none"
                        viewBox="0 0 24 24"
          ...
          <div className="flex items-center justify-center gap-2 mt-6">
            <Button
              variant="ghost"
              className="px-3 py-2 border border-black rounded-md bg-gray-100 font-medium"
            >
              1
            </Button>
            <Button
