...
import BAR_IMG from "../../assets/images/bar.svg";
export const Header = () => {
  ...
  return (
    <header className="w-full">
      <TopPromoBar message="New season coming! Discount 10% for all product! Checkout Now!" />
          ...
          <div className="flex items-center justify-between h-14 md:h-16 px-3 md:px-0">
            <div className="flex-shrink-0">
              <div className="flex items-center">
                <img src={LOGO} alt="logo" className="h-7 w-auto md:h-8" />
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <img src={BAR_IMG} alt="bar" className="md:hidden" style={{marginLeft:"0"}} />
            </div>
          </div>
          {isSearchOpen && (
